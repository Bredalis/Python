...
class Registro:
	...
	def Elaboracion_De_Etiquetas(self):
...
if __name__ == "__main__":
	...
	Clase_Objeto.Elaboracion_De_Frame()
	Clase_Objeto.Elaboracion_De_Entrys()
	Clase_Objeto.Elaboracion_De_Etiquetas()
