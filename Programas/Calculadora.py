...
Numero_5 = tk.Button(Ventana, text = '5', bg = '#66BB6A', cursor = 'heart', width = 4, activebackground = '#F48FB1', command = lambda: Reclick(5)).grid(column = 2, row = 2)
Numero_6 = tk.Button(Ventana, text = '6', bg = '#66BB6A', cursor = 'heart', width = 4, activebackground = '#F48FB1', command = lambda: Reclick(6)).grid(column = 3, row = 2)
...
Numero_8 = tk.Button(Ventana, text = '8', bg = '#66BB6A', cursor = 'heart', width = 4, activebackground = '#F48FB1', command = lambda: Reclick(8)).grid(column = 2, row = 3)
Numero_9 = tk.Button(Ventana, text = '9', bg = '#66BB6A', cursor = 'heart', width = 4, activebackground = '#F48FB1', command = lambda: Reclick(9)).grid(column = 3, row = 3)
...
Signo_Dividir = tk.Button(Ventana, text = '÷', bg = '#66BB6A', cursor = 'heart', width = 4, activebackground = '#F48FB1', command = lambda: Division()).grid(column = 3, row = 4)
...
Numero_PI = tk.Button(Ventana, text = 'π', bg = '#66BB6A', cursor  = 'heart', width = 4, activebackground = '#F48FB1', command = lambda: Reclick(PI)).grid(column = 2, row = 4)
...
Texto = tk.Button(Ventana, text = 'M', width = 4 , bg = '#E0E0E0', activebackground = '#AB47BC', command = lambda: Mensaje(), cursor = 'pirate').grid(column = 1, row = 5)
...
Signo_Igual = tk.Button(Ventana, text = '⌦', bg = '#E0E0E0', cursor  = 'pirate', width = 4, activebackground = '#AB47BC', command = lambda: Clean()).grid(column = 3, row = 5)
