...
def Uploaded_log():
    ...
    if re.match(r"[^@]+@[^@]+\.[^@]+", Valor_Caracter):
        ...
        Resultado = Valor_Texto.set("Por favor ingrese una direccion de correo electronico valida")
     
def Data_cleansing():

	global Resultado

	Resultado = [Valor_Usuario.set(""), Valor_Caracter.set(""), Valor_Contraseña.set(""), Valor_Numero.set(""), Valor_Texto.set("")]
